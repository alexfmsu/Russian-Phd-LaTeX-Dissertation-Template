...
\clearpage
\subsection{Осцилляции в условиях взаимодействия с внешним окружением}
...
\begin{figure}[h!]
	\noindent\centering{
		\includegraphics[width=0.8\textwidth]{Dissertation/images/section_1/bpl/5_5_1000ns.png}\astfootnote\\
		\includegraphics[width=0.85\textwidth]{Dissertation/images/section_1/bpl/5_5_5mks_fid.png}
		\captionsetup{format=hang,width=0.75\textwidth,justification=centering,singlelinecheck=no}
		\\[12pt]
		\caption{
...
\begin{figure}[h!]
	\noindent\centering{
		...
		$|\Psi_0\ra=|\mathrm{0}\ra_{\mathrm{ph}_\mathrm{1}}|\mathrm{0}\ra_{\mathrm{ph}_{\mathrm{2}}}\{0,10\Succ_{\mathrm{at}} = |\mathrm{0}\ra_{\mathrm{ph}_\mathrm{1}}|\mathrm{0}\ra_{\mathrm{ph}_{\mathrm{2}}}\{0\Succ_{\mathrm{1}}\{10\Succ_{\mathrm{2}}$\\
		$|\Psi_1\ra=|\mathrm{0}\ra_{\mathrm{ph}_\mathrm{1}}|\mathrm{0}\ra_{\mathrm{ph}_{\mathrm{2}}}\{10,0\Succ_{\mathrm{at}} = |\mathrm{0}\ra_{\mathrm{ph}_\mathrm{1}}|\mathrm{0}\ra_{\mathrm{ph}_{\mathrm{2}}}\{10\Succ_{\mathrm{1}}\{0\Succ_{\mathrm{2}}$
	}}
\end{figure}
\extrafootertext{\hspace{-2em}{\color{red}*}на вертикальной оси --- вероятность $p(t)$ получения состояния $\{i,j\Succ_{\mathrm{at}}$ в момент времени $t$,\\\indent\hspace{-0.5em}на горизонтальных --- рассматриваемый временной интервал и состояния системы $|\Psi_0\ra$, $|\Psi_1\ra$}
...
\item{
	...
	\\[24pt]
	Так, для системы $m = 100,~n = 100$ базис будет содержать всего 5100 состояний.
	\\[24pt]
